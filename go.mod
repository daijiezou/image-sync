...
require (
	...
	github.com/containerd/accelerated-container-image v0.6.0 // indirect
	...
	github.com/containerd/nerdctl v1.2.1 // indirect
	github.com/containerd/nydus-snapshotter v0.5.1 // indirect
